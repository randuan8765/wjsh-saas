...
Template.contacts.helpers({
  area: function () {
    ...
    var areas = Areas.find().fetch()[0];
    areas.preManager.preManagerMobile = 'tel:' + areas.preManager.preManagerMobile;
    areas.postManager.postManagerMobile = 'tel:' + areas.postManager.postManagerMobile;
    console.log(areas);
    return areas;
  },
  noStore: function() {
    // var d =
    // console.log(document.find( 'body' ).append(d));
    return !Meteor.user().profile.storeId;
  }
});
